 ...
 *
 * @checksum - 764e7690a28573c370695fd65df396af51e256a92ea3e966215e570637b48b29
 * @variables - radius=rounded-xl,accentColor=cyan,colorTemperature=neutral,spacing=2,scale=lg,inputShadow=shadow,baseColorShade=600,borderShadeLightMode=400,borderShadeDarkMode=500,inputMaxWidth=max-w-[20em],tagRadius=rounded,swatchRadius=rounded
 * @theme - regenesis
 **/
...
const classes = {
  ...
  "family:box__decorator": {
    ...
    "bg-white": true,
    "ring-cyan-500": true,
    "peer-checked:border-cyan-600": true,
    relative: true,
    block: true,
    "text-xl": true,
    "w-[1em]": true,
    ...
    "peer-checked:text-cyan-600": true,
    ...
    "dark:ring-offset-cyan-500": true,
    "dark:peer-focus-visible:ring-1": true,
    "dark:peer-disabled:bg-neutral-600/50": true,
    "dark:peer-checked:bg-cyan-900": true,
    "dark:peer-checked:text-cyan-400": true,
  },
  ...
  "family:text__inner": {
    ...
    "focus-within:!border-cyan-500": true,
  ...
  "family:dropdown__listitem": {
    ...
    "data-[is-active]:before:ring-cyan-500": true,
  ...
  "family:dropdown__tag": {
    ...
    "group-data-[active-selection=true]/tag:bg-cyan-400": true,
  ...
  "family:dropdown__emptyMessage": {
    ...
    "aria-selected:bg-cyan-600": true,
  },
  button__input: {
    "appearance-none": true,
    "[color-scheme:light]": true,
  ...
  file__fileRemove: {
    ...
    "peer-data-[has-multiple]:text-cyan-600": true,
  ...
  form__messageLink: {
    ...
    "group-[]/summary:ring-cyan-600": true,
  },
  month__input: {
    "appearance-none": true,
    "[color-scheme:light]": true,
  ...
  range__input: {
    ...
    "[&::-webkit-slider-thumb]:bg-cyan-600": true,
    ...
    "[&::-webkit-slider-thumb]:focus:!ring-cyan-500": true,
    ...
    "[&::-moz-range-thumb]:bg-cyan-600": true,
    ...
    "[&::-moz-range-thumb]:focus:!ring-cyan-500": true,
  ...
  select__option: {
    ...
    "dark:bg-neutral-800": true,
    "dark:text-neutral-300": true,
    "dark:group-data-[multiple]:focus:bg-cyan-800": true,
    "dark:group-data-[multiple]:checked:bg-cyan-800": true,
  },
  select__prefixIcon: {
    flex: true,
    "items-center": true,
  ...
  submit__input: {
    ...
    "active:bg-cyan-700": true,
    "hover:bg-cyan-700": true,
  ...
  colorpicker__fieldGroup: {
    ...
    "[&>input:focus]:ring-cyan-600": true,
    "[&>input:focus]:border-cyan-600": true,
  ...
  colorpicker__swatch: {
    ...
    "[&>canvas:focus-visible]:ring-cyan-500": true,
  ...
  datepicker__dayCell: {
    ...
    "dark:bg-neutral-600": true,
    "dark:text-neutral-300": true,
    "dark:aria-selected:bg-cyan-600": true,
    "dark:aria-selected:text-white": true,
    "dark:focus:outline-cyan-600": true,
  ...
  datepicker__timeInput: {
    ...
    "p-1.5": true,
    "my-2.5": true,
    "focus-visible:outline-cyan-600": true,
    "dark:text-neutral-300": true,
    "dark:bg-transparent": true,
    "dark:border-neutral-600": true,
  },
  ...
  datepicker__calendarIcon: {
    "text-neutral-600": true,
    "focus-visible:text-cyan-600": true,
    flex: true,
    "w-[1em]": true,
    "grow-0": true,
    "shrink-0": true,
  ...
  togglebuttons__input: {
    ...
    "dark:text-cyan-500": true,
    "aria-[pressed=true]:bg-cyan-600": true,
    "aria-[pressed=true]:text-white": true,
    "dark:aria-[pressed=true]:bg-cyan-600": true,
    ...
    "group-data-[vertical=false]/options:group-[]/option:aria-[pressed=true]:border-x-cyan-500": true,
    "group-data-[vertical=false]/options:group-first/option:aria-[pressed=true]:border-l-cyan-600": true,
    "group-data-[vertical=false]/options:group-last/option:aria-[pressed=true]:border-r-cyan-600": true,
    "dark:group-data-[vertical=false]/options:group-[]/option:aria-[pressed=true]:border-x-cyan-600": true,
    "dark:group-data-[vertical=false]/options:group-first/option:aria-[pressed=true]:border-l-cyan-600": true,
    "dark:group-data-[vertical=false]/options:group-last/option:aria-[pressed=true]:border-r-cyan-600": true,
    ...
    "group-data-[vertical=true]/options:group-[]/option:aria-[pressed=true]:border-y-cyan-500": true,
    "group-data-[vertical=true]/options:group-first/option:aria-[pressed=true]:border-t-cyan-600": true,
    "group-data-[vertical=true]/options:group-last/option:aria-[pressed=true]:border-b-cyan-600": true,
    "dark:group-data-[vertical=true]/options:group-[]/option:aria-[pressed=true]:border-y-cyan-600": true,
    "dark:group-data-[vertical=true]/options:group-first/option:aria-[pressed=true]:border-t-cyan-600": true,
    "dark:group-data-[vertical=true]/options:group-last/option:aria-[pressed=true]:border-b-cyan-600": true,
  },
  transferlist__outer: {
    group: true,
    "min-w-0": true,
    ...
    "text-lg": true,
    "max-w-none": true,
    "[&_.dnd-placeholder]:bg-cyan-600": true,
  ...
  transferlist__transferlist: {
    ...
    "[&:has(:focus-visible)]:ring-cyan-500": true,
    "dark:border-neutral-600": true,
  ...
  transferlist__transferlistListItem: {
    ...
    "dark:bg-neutral-800": true,
    "dark:text-neutral-300": true,
    "dark:data-[is-active=true]:bg-cyan-900": true,
    "dark:aria-selected:bg-cyan-900": true,
  ...
  "multi-step__tab": {
    ...
    "group-data-[tab-style=progress]/wrapper:data-[valid=true]:data-[visited=true]:after:bg-cyan-600": true,
    ...
    "dark:group-data-[tab-style=progress]/wrapper:data-[valid=true]:data-[visited=true]:after:bg-cyan-600": true,
  },
  ...
  "multi-step__badge": {
    ...
    "text-white": true,
    "rounded-full": true,
    "group-data-[valid=true]/tab:bg-cyan-600": true,
